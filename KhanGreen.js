...
function setupMain(){
    function spoofQuestion() {
        const phrases = [ "🔥 Get good, get [KhanGreen](https://github.com/Niximkk/khanware/)!", "🤍 Made by [@im.nix](https://e-z.bio/sounix).", "☄️ By github.com/Niximkk/khanware/ " ];
    ...
    function changeBannerText() {
        const phrases = [ "[🌿] Non Skeetless dude.", "[🌿] KhanGreen on top.", "[🌿] Nix said hello!", "[🌿] God i wish i had KhanGreen.", "[🌿] Get good get KhanGreen!", "[🌿] the old khanware.space" ];
        setInterval(() => { 
